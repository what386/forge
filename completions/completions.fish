...
complete -c forge -n "__fish_forge_needs_command" -f -a "remove" -d 'Remove local template(s)'
...
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create remove check trust config package help" -f -a "remove" -d 'Remove local template(s)'
