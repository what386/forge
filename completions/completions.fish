...
complete -c forge -n "__fish_forge_using_subcommand create" -s g -l global -d 'Create in ~/.forge/templates/ instead of .forge/templates/'
...
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "new" -d 'Scaffold a new project from a template'
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "list" -d 'List available templates'
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "info" -d 'Print details about a template'
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "create" -d 'Scaffold a new blank template'
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "check" -d 'Check a template without executing it'
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "trust" -d 'Manage template trust'
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "config" -d 'Manage Forge configuration'
complete -c forge -n "__fish_forge_using_subcommand help; and not __fish_seen_subcommand_from new list info create check trust config help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
