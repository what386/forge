_forge() {
    ...
    do
        case "${cmd},${i}" in
            ",$1")
                ...
                ;;
            forge,check)
                cmd="forge__subcmd__check"
                ;;
            forge,config)
                cmd="forge__subcmd__config"
                ;;
            forge,create)
            ...
            forge,help)
                ...
                ;;
            forge,info)
                cmd="forge__subcmd__info"
                ;;
            forge,list)
                cmd="forge__subcmd__list"
                ;;
            forge,new)
            ...
            forge,trust)
                ...
                ;;
            forge__subcmd__config,edit)
                cmd="forge__subcmd__config__subcmd__edit"
                ;;
            forge__subcmd__config,get)
                cmd="forge__subcmd__config__subcmd__get"
                ;;
            forge__subcmd__config,help)
                cmd="forge__subcmd__config__subcmd__help"
                ;;
            forge__subcmd__config,list)
                cmd="forge__subcmd__config__subcmd__list"
                ;;
            forge__subcmd__config,set)
                cmd="forge__subcmd__config__subcmd__set"
                ;;
            forge__subcmd__config__subcmd__help,edit)
                cmd="forge__subcmd__config__subcmd__help__subcmd__edit"
                ;;
            forge__subcmd__config__subcmd__help,get)
                cmd="forge__subcmd__config__subcmd__help__subcmd__get"
                ;;
            forge__subcmd__config__subcmd__help,help)
                cmd="forge__subcmd__config__subcmd__help__subcmd__help"
                ;;
            forge__subcmd__config__subcmd__help,list)
                cmd="forge__subcmd__config__subcmd__help__subcmd__list"
                ;;
            ...
            forge__subcmd__help,check)
                ...
                ;;
            forge__subcmd__help,config)
                cmd="forge__subcmd__help__subcmd__config"
                ;;
            ...
            forge__subcmd__help,help)
                ...
                ;;
            forge__subcmd__help,info)
                cmd="forge__subcmd__help__subcmd__info"
                ;;
            forge__subcmd__help,list)
                cmd="forge__subcmd__help__subcmd__list"
                ;;
            ...
            forge__subcmd__help,trust)
                ...
                ;;
            forge__subcmd__help__subcmd__config,edit)
                cmd="forge__subcmd__help__subcmd__config__subcmd__edit"
                ;;
            forge__subcmd__help__subcmd__config,get)
                cmd="forge__subcmd__help__subcmd__config__subcmd__get"
                ;;
            forge__subcmd__help__subcmd__config,list)
                cmd="forge__subcmd__help__subcmd__config__subcmd__list"
                ;;
            ...
            forge__subcmd__help__subcmd__trust,add)
                ...
                ;;
            forge__subcmd__help__subcmd__trust,list)
                cmd="forge__subcmd__help__subcmd__trust__subcmd__list"
                ;;
            ...
            forge__subcmd__trust,add)
                ...
                ;;
            forge__subcmd__trust,help)
                cmd="forge__subcmd__trust__subcmd__help"
                ;;
            forge__subcmd__trust,list)
                cmd="forge__subcmd__trust__subcmd__list"
                ;;
            forge__subcmd__trust,remove)
                cmd="forge__subcmd__trust__subcmd__remove"
                ;;
            forge__subcmd__trust__subcmd__help,add)
                cmd="forge__subcmd__trust__subcmd__help__subcmd__add"
                ;;
            forge__subcmd__trust__subcmd__help,help)
                cmd="forge__subcmd__trust__subcmd__help__subcmd__help"
                ;;
            forge__subcmd__trust__subcmd__help,list)
                cmd="forge__subcmd__trust__subcmd__help__subcmd__list"
                ;;
            forge__subcmd__trust__subcmd__help,remove)
                cmd="forge__subcmd__trust__subcmd__help__subcmd__remove"
                ;;
            *)
                ;;
        esac
    ...
    case "${cmd}" in
        ...
        forge__subcmd__check)
            ...
            return 0
            ;;
        forge__subcmd__config)
            opts="-h --help set get list edit help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__edit)
            opts="-h --help"
        ...
        forge__subcmd__config__subcmd__get)
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__help)
            opts="set get list edit help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__help__subcmd__edit)
            opts=""
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__help__subcmd__get)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__help__subcmd__list)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__help__subcmd__set)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__config__subcmd__list)
            opts="-h --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        forge__subcmd__help)
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__check)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__config)
            opts="set get list edit"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__config__subcmd__edit)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__config__subcmd__get)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__config__subcmd__list)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__config__subcmd__set)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        forge__subcmd__help__subcmd__help)
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__info)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__list)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__new)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        forge__subcmd__help__subcmd__trust)
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__trust__subcmd__add)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__trust__subcmd__list)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__help__subcmd__trust__subcmd__remove)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
        ...
        forge__subcmd__trust__subcmd__add)
            ...
            return 0
            ;;
        forge__subcmd__trust__subcmd__help)
            ...
            return 0
            ;;
        forge__subcmd__trust__subcmd__help__subcmd__add)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__trust__subcmd__help__subcmd__help)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__trust__subcmd__help__subcmd__list)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__trust__subcmd__help__subcmd__remove)
            opts=""
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 4 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            ...
            return 0
            ;;
        forge__subcmd__trust__subcmd__list)
            opts="-h --help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
