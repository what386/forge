forge.path = forge.path or {}

local sep = (forge.project and type(forge.project.dir) == "string"
    and forge.project.dir:find("\\", 1, true)) and "\\" or "/"
...
forge.path.basename = function(path)
...
forge.path.stem = function(path)
    local base = forge.path.basename(path)
